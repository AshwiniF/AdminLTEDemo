		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="/operatorslink"><i
						...
						<div class="box">
							...
							<div class="box-body table-responsive no-padding">
								<table class="table table-hover">
									...
									<c:forEach var="operators" items="${listOfOperator}">
									
										<tr>
											<td><c:out value="${operators.getId()}" /></td>
											...
											<td><c:out value="${operators.getTiming() }" /></td>
										</tr>
									</c:forEach>
								</table>
							</div>
